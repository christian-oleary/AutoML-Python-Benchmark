...
class Forecasting:
    ...
    def _init_forecaster(  # noqa: C901
        ...
        if forecaster_name == 'test':
            ...
            from src.automl.autogluon.models import AutoGluonForecaster as forecaster
        elif forecaster_name == 'autokeras':
            from src.automl.autokeras.models import AutoKerasForecaster as forecaster
        elif forecaster_name == 'autots':
            from src.automl.autots.models import AutoTSForecaster as forecaster
        elif forecaster_name == 'autopytorch':
            from src.automl.autopytorch.models import AutoPyTorchForecaster as forecaster
        elif forecaster_name == 'etna':
            from src.automl.etna.models import ETNAForecaster as forecaster
        elif forecaster_name == 'evalml':
            from src.automl.evalml.models import EvalMLForecaster as forecaster
        elif forecaster_name == 'fedot':
            from src.automl.fedot.models import FEDOTForecaster as forecaster
        elif forecaster_name == 'flaml':
            from src.automl.flaml.models import FLAMLForecaster as forecaster
        elif forecaster_name == 'ludwig':
            from src.automl.ludwig.models import LudwigForecaster as forecaster
        elif forecaster_name == 'pycaret':
            from src.automl.pycaret.models import PyCaretForecaster as forecaster
        else:
