...
class TestGitRepoInit:
    ...
    def test_init_with_github_url(self, mock_library: Mock, tmp_path, mocker):
    ...
    def test_init_with_non_github_url(self, mock_library, mocker):
    ...
    def test_init_without_github_token_env_var(self, mock_library, mocker):
...
class TestGithubLogin:
    ...
    def test_github_login_with_token(self, mock_library, tmp_path, mocker):
    ...
    def test_github_login_with_env_variable(self, mock_library, tmp_path, mocker):
    ...
    def test_github_login_without_token(self, mock_library, mocker):
...
class TestCloneAndScrape:
    ...
    def test_clone_new_repository(self, mock_library, tmp_path, mocker):
    ...
    def test_use_existing_repository(self, mock_library, tmp_path, mocker):
...
class TestFromPackageName:
    ...
    def test_from_package_name_valid(self, mock_library, mocker):
...
class TestFetchBasicInfo:
    ...
    def test_fetch_basic_info(self, mock_library, tmp_path, mocker):
