...
try:    from autogluon.timeseries import TimeSeriesPredictor
except: from autogluon.timeseries.predictor import TimeSeriesPredictor
        ...
        for channel in range(self.input_c):
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                predictor = TimeSeriesPredictor(
                    prediction_length=self.prediction_length, path=temp_dir, log_file_path=False,
                ).fit(
                        train_data, 
                        hyperparameters={
                        "Chronos": {
