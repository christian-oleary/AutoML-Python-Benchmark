...
The `src/ml` folder contains code for benchmarking AutoML libraries for time series forecasting and anomaly detection. It also contains code for source code analysis of AutoML repositories via Sonar Scanner.
