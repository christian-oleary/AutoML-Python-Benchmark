...
- Hyperopt-sklearn removed as not really an AutoML library
...
|                   | Tabular    | Tabular        | Image          | Text           |            | Forecasting | Forecasting  | Forecasting  | TSC            | TSC               | TS                | Link
| ---               | ---        | ---            | ---            | ---            | ---        | ---         | ---          | ---          | ---            | ---               | ---               | ---
| Library           | Regression | Classification | Classification | Classification | Clustering | Univariate  | Multivariate | Global/Panel | By series      | By Point          | Anomaly Detection | Link
| ---               | ---        | ---            | ---            | ---            | ---        | ---         | ---          | ---          | ---            | ---               | ---               | ---
| Auto-PyTorch      | Yes        | Yes            | No             | No             | No         | Yes         | No           | No           | No (1)         | No                | No                | <https://automl.github.io/Auto-PyTorch/master/manual.html>
| Auto-Sklearn      | Yes        | Yes            | No             | No             | No         | No          | No           | No           | No             | No                | No                | <https://automl.github.io/auto-sklearn/master/manual.html>
| AutoGluon         | Yes        | Yes            | Yes            | Yes            | No         | Yes         | Yes          | Yes          | No             | No                | Yes (2)           | <https://auto.gluon.ai/stable/index.html>
| AutoKeras         | Yes        | Yes            | Yes            | Yes            | No         | No (4)      | No (4)       | No (4)       | No (4)         | No (4)            | Domain-specific   | <https://autokeras.com/>
| AutoTS            | No (3)     | No (3)         | No             | No             | No         | Yes         | Yes          | No           | No             | No                | Yes               | <https://winedarksea.github.io/AutoTS/build/html/index.html>
| EvalML            | Yes        | Yes            | No             | Yes            | No         | Yes         | Yes          | No (5)       | No (6)         | Yes (6)           | No (7)            | <https://evalml.alteryx.com/en/stable/api_index.html#pipelines>
| FEDOT             | Yes        | Yes            | Yes?           | Yes            | No         | Yes         | Yes          | No           | No             | No                | No                | <https://fedot.readthedocs.io/en/latest/api/api.html#fedot-api>
| Fedot.Industrial  | Yes        | Yes            | Yes?           | Yes?           | No         | Yes         | Yes          | No           | Yes            | No                | No                | <https://github.com/aimclub/Fedot.Industrial>
| FLAML             | Yes        | Yes            | ???            | Yes            | No         | Yes         | Yes          | Yes          | No  (8)        | Yes (8)           | No                | <https://microsoft.github.io/FLAML/>
| H2O-3 (H2OAutoML) | Yes        | Yes            | No             | No?            | Yes        | No          | No           | No           | No             | No                | No                | <https://docs.h2o.ai/h2o/latest-stable/h2o-docs/index.html>
| HyperTS           | No (10)    | No (10)        | No (10)        | No (10)        | No (10)    | Yes         | Yes          | Yes          | Yes            | No (3)            | Yes               | <https://github.com/DataCanvasIO/HyperTS>
| KATS              | No         | No             | No?            | No?            | No         | Yes         | Yes          | Yes          | No (9)         | No                | Yes               | <https://facebookresearch.github.io/Kats/>
| LightAutoML       | Yes        | Yes            | Yes            | Yes            | No         | No          | No           | No           | No             | No                | No                | <https://lightautoml.readthedocs.io/en/v.0.4.0/pages/tutorials/Tutorial_1_basics.html#1.1.-Task-type>
...
<!-- | Hyperopt-sklearn  | Yes        | Yes            | ???            | ???            | Yes        | No          | No           | No           | No             | No                | No                | <https://github.com/hyperopt/hyperopt-sklearn> -->
...
- Notes:
    ...
    6. Point classification only. EvalML claims to have time series classification but documentation is non-existent and source code indicates that this functionality is not fully implemented yet.
